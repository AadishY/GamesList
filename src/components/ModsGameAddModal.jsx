...
export default function ModsGameAddModal({ mainGames, mods, addFirebaseMod, activeProfile, onClose, theme }) {
        ...
        <div className="p-4 sm:p-6 pb-2 shrink-0 border-b-2 border-black/5 dark:border-white/5">
          <div className="relative group">
            ...
            <input type="text" value={search} onChange={e => setSearch(e.target.value)}
              ...
              className="w-full bg-white/50 dark:bg-black/80 border-2 border-black/10 dark:border-white/20 rounded-2xl pl-12 pr-24 py-4 sm:py-3 text-base sm:text-lg font-black outline-none focus:border-black dark:focus:border-white focus:bg-white dark:focus:text-black focus:text-black focus:shadow-brutal transition-all placeholder-black/60 dark:placeholder-white/30 text-black dark:text-white"
            />
