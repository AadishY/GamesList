      ...
      <div className="flex flex-col sm:flex-row w-full xl:w-auto gap-2 sm:gap-3 flex-shrink-0">
        ...
        <div className="relative flex items-center flex-1 sm:flex-initial min-w-[140px]">
          ...
          <select value={sortOption} onChange={(e) => setSortOption(e.target.value)}
            className="w-full bg-white/50 dark:bg-black/80 border-2 border-black/10 dark:border-white/20 rounded-xl pl-10 pr-10 py-3 text-[10px] sm:text-xs font-black uppercase tracking-widest outline-none focus:border-black dark:focus:border-white focus:bg-white focus:shadow-brutal transition-[border-color,background-color,box-shadow] appearance-none cursor-pointer text-black dark:text-white"
          >
        ...
        <div className="relative w-full sm:w-64 flex-shrink-0 group">
          ...
          <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="SEARCH..."
            className="w-full bg-white/50 dark:bg-black/80 border-2 border-black/10 dark:border-white/20 rounded-xl pl-11 pr-4 py-3 text-[10px] sm:text-xs font-black uppercase tracking-widest placeholder-black/60 dark:placeholder-white/40 outline-none focus:border-black dark:focus:border-white focus:bg-white focus:shadow-brutal transition-[border-color,background-color,box-shadow] text-black dark:text-white"
          />
        </div>
      </div>
    </section>
